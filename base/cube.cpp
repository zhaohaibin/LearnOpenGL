...
int cube::gen_buffer_data(float* data)
{
	...
	float vertices[] = {
		px1, py1, pz1, 0.0f, 0.0f, 
		px2, py2, pz2, 0.0f, 1.0f,
		px3, py3, pz3, 1.0f, 1.0f,
		px4, py4, pz4, 1.0f, 0.0f, 

		px2, py2, pz2, 0.0f, 0.0f,
		px6, py6, pz6, 0.0f, 1.0f,
		px7, py7, pz7, 1.0f, 1.0f,
		...
		px1, py1, pz1, 1.0f, 0.0f,
		px4, py4, pz4, 0.0f, 0.0f,
		px8, py8, pz8, 0.0, 1.0,
		px5, py5, pz5, 1.0f, 1.0f,
		
		px1, py1, pz1, 0.0f, 0.0f,
		px5, py5, pz5, 0.0f, 1.0f,
		px6, py6, pz6, 1.0, 1.0,
		px2, py2, pz2, 1.0f, 0.0f,
		
		
		px4, py4, pz4, 1.0f, 0.0f,
		px3, py3, pz3, 0.0f, 0.0f,
		px7, py7, pz7, 0.0, 1.0,
		px8, py8, pz8, 1.0, 1.0,
	};
